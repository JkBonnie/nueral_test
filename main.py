...
def main():
    axons = []
    dendrites = []
    neuron = Neuron(200,200)
    axon = Axon(neuron, 180, 30)
    neuron.addAxon(axon)
    axons.append(axon)
    dendrite = Dendrite(neuron = neuron,direction= 0,charge = 0, length=20, range = 100, range_falloff_power= 1)
    neuron.addDendrite(dendrite)
    dendrites.append(dendrite)
    axon.find_in_range_dendrites(dendrites)
    

    neuron2 = Neuron(300,150, potential = 10,charge_rate = 0.1,threshold = 10, potential_reset = 0, reset_randomness = 0, fire_power = 30)
    axon2 = Axon(neuron2, 210, 30)
    neuron2.addAxon(axon2)
    axons.append(axon2)
    dendrite2 = Dendrite(neuron = neuron2,direction= 70,charge= 0, length=20, range = 100, range_falloff_power = 1)
    ...
    sim = Simulation_display(400, 400, [neuron, neuron2], axons, dendrites)
    sim.run()
